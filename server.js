...
const GEO_RU = new Set([
  ...
  'Россия','России','Российской','Российской','Китай','Китая','Китае','Китаем',
  'Германия','Германии','Германию','Франция','Франции','Францию',
  'США','Япония','Японии','Японию','Корея','Кореи','Корею',
  'Индия','Индии','Индию','Турция','Турции','Турцию',
  'ОАЭ','Катар','Катара','Катаре','Израиль','Израиля',
  'Казахстан','Казахстана','Казахстане','Азербайджан','Азербайджана',
  'Туркменистан','Туркменистана','Таджикистан','Таджикистана',
  'Кыргызстан','Кыргызстана','Пакистан','Пакистана','Бангладеш',
  'Сингапур','Сингапура','Нидерланды','Нидерландов','Швейцария','Швейцарии',
  'Австралия','Австралии','Канада','Канады','Бразилия','Бразилии',
  'Великобритания','Великобритании','Ирландия','Ирландии',
  'Норвегия','Норвегии','Швеция','Швеции','Финляндия','Финляндии',
  'Польша','Польши','Чехия','Чехии','Австрия','Австрии',
  // Cities
  'Лондон','Лондоне','Лондона','Москва','Москве','Москвы','Москвой',
  'Пекин','Пекине','Пекина','Ташкент','Ташкенте','Ташкента',
  'Париж','Париже','Парижа','Берлин','Берлине','Берлина',
  'Дубай','Дубае','Дубая','Астана','Астане','Астаны',
  'Алматы','Токио','Нью-Йорк','Нью-Йорке','Нью-Йорка',
  'Сан-Франциско','Лос-Анджелес','Хьюстон','Вашингтон','Чикаго','Сиэтл',
  'Амстердам','Брюссель','Цюрих','Женева','Вена','Варшава','Прага',
  'Стамбул','Анкара','Тегеран','Эр-Рияд','Абу-Даби','Доха',
  'Мумбаи','Дели','Бангалор','Шанхай','Гонконг','Сеул','Сингапур',
  'Сидней','Торонто','Монреаль','Сан-Паулу','Мехико','Джакарта',
  // US States
  'Техас','Техаса','Техасе','Калифорния','Калифорнии','Флорида','Флориды',
  'Нью-Йорк','Невада','Делавэр','Вирджиния','Иллинойс','Вашингтон',
  // Regions
  'Африка','Африке','Африки','Африкой','Субсахарской',
  'Америка','Америке','Америки','Америкой',
  'Европа','Европе','Европы','Европой',
  'Азия','Азии','Азией',
  'Центральной','Центральная','Центральное',
  'Южной','Южная','Восточной','Восточная',
  'Западной','Западная','Северной','Северная','Северо-Американском',
  'Ближний','Ближнем','Востоке','Востока','Востоком',
  'Тихоокеанском','Латинской','Латинская','Скандинавии',
]);
...

{
  ...
  "company_description_paragraphs": [
    ...
    "Параграф 2 (3-4 предложения): АКТУАЛЬНЫЕ финансовые показатели 2024-2025 из последних отчётов - выручка, чистая прибыль, совокупные активы, рыночная капитализация. Пример: 'Совокупные активы компании по итогам 2024 г. составили $ 90+ млрд. Годовая выручка - $ 21,4 млрд. Чистая прибыль - $ 4,2 млрд.'",
...
ТРЕБОВАНИЯ:
- company_description_paragraphs: РОВНО 5 параграфов, КАЖДЫЙ содержательный, ПОЛНЫЕ предложения, вся страница текста:
  * Параграф 1: основная деятельность, год основания, штаб-квартира (город, штат/страна). Полная история.
  * Параграф 2: финансовые показатели 2024-2025 - выручка, активы, прибыль с ТОЧНЫМИ цифрами и источниками
...
- company_uzbekistan: минимум 3 отрасли. ВАЖНО: если реальных данных нет - пиши "Компания не имеет подтверждённого присутствия в Узбекистане. Однако в рамках стратегии расширения в Центральную Азию возможно сотрудничество в следующих направлениях: [предложения]"
- education: хронологически от старого к новому, минимум 1
- career: хронологически от старого к новому, ВСЕ должности которые найдёшь, текущая - ПОСЛЕДНЯЯ
- Годы ТОЛЬКО с дефисом: "1999-2007 гг."

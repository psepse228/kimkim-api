...
async function researchPerson(input) {
  ...
  const [bioText, uzbekText, newsText, linkedinText, personImg, logoImg] = await Promise.all([
    tavilySearch(`${nameQuery} biography education career professional background`),
    tavilySearch(`${coQuery} Uzbekistan investment projects cooperation agreements 2024 2025`),
    tavilySearch(`${coQuery} latest news annual report revenue employees 2024 2025`),
    linkedin ? tavilySearch(`${nameQuery} LinkedIn career history`) : Promise.resolve(''),
...

{
  ...
  "company_activities_list": [
    "Направление 1 — краткое описание",
    "Направление 2 — краткое описание",
    "Направление 3 — краткое описание"
  ],
